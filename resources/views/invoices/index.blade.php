                        ...
                        <div class="invoice-info">
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-50">
                                    ...
                                    <p class="inv-from-1">{{ $user->name }}</p>
                                    <p class="inv-from-1">{{ $user->phone }}</p>
                                    <p class="inv-from-1">{{ $user->email }}</p>
                                    <p class="inv-from-2">{{ $user->address }}</p>
                                </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center mx-auto" id="modalCenterTitle">Invoice of {{ $user->name }}<br />Total Amount ${{ Cart::total() }}</h3>
                </div>
